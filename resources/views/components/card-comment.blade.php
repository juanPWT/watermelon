   @props(['picture', 'name', 'content', 'created_at', 'owner'])
   ...
   <div class="w-full flex  gap-3">
    ...
    <div class="flex flex-col gap-2 justify-start w-full">
          <div class="flex gap-1 items-center">
              ...
              &#8226;
              <span class="text-base font-light text-slate-800">{{ $created_at ?? 'now' }}</span>
              @if ($isOwner)
                  &#8226;
          ...
          <div class="flex w-full justify-end items-center gap-5">
              <button class="text-sm font-semibold text-slate-800"><i class="fa-solid fa-thumbs-up"></i> like ?</button>
